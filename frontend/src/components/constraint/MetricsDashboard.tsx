    ...
    <div className="mb-3">
      <div className="flex justify-between text-xs mb-1 font-mono">
        ...
        <span style={{ color }} className="font-mono">
          {value}{unit}{sla != null ? <span className="text-slate-700"> / {sla}{unit}</span> : null}
        </span>
      </div>
...
export function MetricsDashboard({ metrics, level }: { metrics: Metrics | null; level: any }) {
  return (
    <div className="border border-[#1a1a1a] p-4">
      ...
      {!metrics ? (
        <div className="text-slate-700 text-sm py-8 text-center font-mono">
        ...
        <>
          ...
          <div className="flex justify-between text-xs mt-2 text-slate-600 font-mono">
